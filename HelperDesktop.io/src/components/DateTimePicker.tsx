...
export default function DateTimePicker({ value, onChange }: DateTimePickerProps) {
  ...
  const setHour = (h: number) => {
    const v = ((h % 24) + 24) % 24;
    setHours(v);
    if (selectedDate) applyValue(selectedDate.year, selectedDate.month, selectedDate.day, v, minutes);
  };

  const setMin = (m: number) => {
    const v = ((m % 60) + 60) % 60;
    setMinutes(v);
    if (selectedDate) applyValue(selectedDate.year, selectedDate.month, selectedDate.day, hours, v);
  };
          ...
          >
            ...
            <div className="dtpicker-time">
              ...
              <div className="dtpicker-time-controls">
                ...
                <div className="dtpicker-spin">
                  <button onClick={() => setMin(minutes + 5)} type="button">▲</button>
