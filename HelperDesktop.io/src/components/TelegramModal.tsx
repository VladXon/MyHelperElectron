...
import { X, QrCode, Key, User, Check, Copy } from '@phosphor-icons/react';
...
export default function TelegramModal({ onClose, onLinked }: TelegramModalProps) {
  ...
  return (
    ...
    >
      <motion.div className="modal-card telegram-modal" onClick={e => e.stopPropagation()}
      ...
      >
        ...
        <div className="modal-header">
          ...
          <h2 className="modal-title">Привязка Telegram</h2>
          <p className="modal-subtitle">Выберите способ привязки</p>
        </div>
